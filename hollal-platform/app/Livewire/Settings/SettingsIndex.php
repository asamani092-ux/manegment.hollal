...
class SettingsIndex extends Component
{
    ...
    public static function helpFor(string $key): string
    {
        return match ($key) {
            ...
            'attendance.cycle_start_day' => 'يوم بداية دورة الحضور (مثل 25) لحساب نافذة الخصم.',
            'attendance.cycle_days' => 'عدد أيام الدورة لقسمة الراتب واستخراج قيمة اليوم.',
            'attendance.grace_minutes' => 'دقائق السماح قبل احتساب التأخير.',
            'attendance.absence_multiplier' => 'مضاعف خصم الغياب (مثل 1.5).',
            'attendance.absence_policy' => 'سياسة الغياب: ثابت أو تصاعدي (الجداول لاحقاً).',
            'attendance.site_barcode_token' => 'رمز باركود المقر لتسجيل الحضور بالمسح.',
            'hr.daily_base_hours' => 'ساعات الدوام اليومية لحساب قيمة الساعة.',
