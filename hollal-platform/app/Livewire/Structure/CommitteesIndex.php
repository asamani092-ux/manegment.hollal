...
class CommitteesIndex extends Component
{
    ...
    public function addMember(): void
    {
        ...
        $this->addUserId = null;
        $this->dispatch('ds-toast', type: 'success', message: 'أُضيف الموظف إلى اللجنة');
    }
    ...
    public function removeMember(int $userId): void
    {
        ...
        $this->dispatch('ds-toast', type: 'success', message: 'أُزيل العضو');
    }
    ...
    public function addGuest(): void
    {
        ...
        $this->guestRole = 'مستشار';
        $this->dispatch('ds-toast', type: 'success', message: 'أُضيف ضيف غير موظف');
    }
    ...
    public function removeGuest(string $guestId): void
    {
        ...
        $this->dispatch('ds-toast', type: 'success', message: 'أُزيل الضيف');
    }
