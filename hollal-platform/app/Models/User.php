...
#[Fillable(['name', 'email', 'phone', 'password', 'must_change_password', 'department_id', 'manager_id', 'is_active', 'attendance_enabled', 'employment_status', 'offboarding_started_at'])]
