...
return [
    ...
    'notes' => [
        ...
        'docs' => 'اسم التنزيل عربي أو ترميز إنجليزي سليم وليس عشوائياً. إضافة معاينة للملفات.',
        'doc-templates' => 'تكرار التبويب مستقلاً وداخل المكتبة. إضافة معاينة وتنزيل وتحديد من يظهر له النموذج. زر المستندات يعيد للمستودع بلا فائدة.',
        'versions' => 'التأكد أن آخر نسخة هي التي في المستودع. إعادة دراسة التبويب إن لم تبقَ له فائدة.',
        'policies' => 'أين تظهر السياسات وملف المهام ولمن وكيف يُحدَّد ملف كل إدارة؟',
        'minutes-arch' => 'مسار طلب التعديل بعد الموافقة: معاينة النسخة الجديدة؟ استبدال أم محضر إلحاقي؟',
