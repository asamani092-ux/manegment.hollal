...
return [
    ...
    'phases' => [
        [
            ...
            'goal' => 'الأساس · الدخول · دليل العاملين · قوالب/دورات التقييم · الحضور · الإجازات · دورة الحياة',
    ...
    'groups' => [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'eval-templates', 'tool' => 'قوالب التقييم', 'path' => '/evaluation-templates', 'checks' => 'قالب متعدد · بنود مدير/موارد · أوزان = 100 · عربية', 'lifecycle' => 'إنشاء قالب → بنود وأوزان → تفعيل'],
                ['id' => 'eval-cycles', 'tool' => 'دورات التقييم', 'path' => '/evaluation-cycles', 'checks' => 'فتح ربع · اختيار قالب · لقطة ثابتة · فتح جماعي · استثناء مجمّد/منتصف الربع', 'lifecycle' => 'إنشاء دورة → ربط قالب → فتح جماعي → إغلاق'],
                ['id' => 'evaluations', 'tool' => 'التقييم الربعي (لوحة الموارد)', 'path' => '/evaluations', 'checks' => 'دورة مفتوحة · قسم موارد · تقارير حضور/مهام مرجعية · اعتماد (يظهر للموظف) · تعديل بسبب · إغلاق بأرشفة', 'lifecycle' => 'مسودة → اعتماد → أرشفة (لا نشر)'],
                ['id' => 'team-evaluations', 'tool' => 'تقييمات فريقي', 'path' => '/team-evaluations', 'checks' => 'فريق المدير فقط · بنود قسم المدير · مكتمل/غير مكتمل · بلا مجموع نهائي ولا درجات الموارد', 'lifecycle' => 'تعبئة بنود المدير → اكتمال القسم'],
                ['id' => 'my-evaluations', 'tool' => 'أرشيف تقييماتي', 'path' => '/my-evaluations', 'checks' => 'يظهر بعد الاعتماد فقط · بلا تعليق موظف · عرض الدرجات المعتمدة/المؤرشفة', 'lifecycle' => 'اعتماد الموارد → ظهور للموظف'],
                ...
                ['id' => 'attendance', 'tool' => 'الحضور (برنامج التحضير)', 'path' => '/attendance', 'checks' => 'ورديات · تفعيل · زر هيدر · أنواع حضور/عن بعد/ميداني · اعتماد مدير · باركود مقر · مواقع · عمل إضافي للعرض فقط · بطاقات مغلقة', 'lifecycle' => 'إسناد وردية → تفعيل → تسجيل → اعتماد عن بعد/ميداني → تقرير'],
                ['id' => 'attendance-cycle', 'tool' => 'الحضور الشهري (استيراد)', 'path' => '/attendance/cycle', 'checks' => 'رفع يستبدل · مطابقة أعمدة عربية + تعلّم جهة · مطابقة بصمة يدوية · ساعات يدوية→خصم من معادلات · اعتماد · تصحيح بسبب', 'lifecycle' => 'رفع/إدخال → تقرير → اعتماد خصم → تطبيق مسير'],
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'profile', 'tool' => 'الملف الوظيفي', 'path' => '/users/{id}/profile', 'checks' => 'بيانات · هيكل · تقييمات معتمدة في الأرشيف · إجازات · راتب', 'lifecycle' => 'عرض → تحديث → سجل تاريخي'],
            ],
        ],
        [
            'id' => 'roles',
