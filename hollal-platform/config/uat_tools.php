...
return [
    ...
    /** تقييم عبدالله 2026-08-14 — يُحمَّل افتراضيًا في الواجهة. */
    'baseline' => require __DIR__.'/uat_baseline_round3.php',
    ...
    'groups' => [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'evaluations', 'tool' => 'التقييم الدوري', 'path' => '/evaluations', 'checks' => 'إنشاء 2026-Q3 · رفض التكرار · داخلي للموارد افتراضيًا · إظهار للموظف اختياري · فلاتر'],
