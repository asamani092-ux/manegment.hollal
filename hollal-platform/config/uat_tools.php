...
return [
    ...
    'groups' => [
        [
            ...
            'items' => [
                ['id' => 'sidebar', 'tool' => 'الشريط الجانبي', 'path' => 'أي صفحة', 'checks' => 'طي الشريط على الشاشة الكبيرة · طي المجموعة وفتحها · بقاء الحالة بعد التحديث · فتح مجموعة الصفحة الحالية تلقائيًا'],
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'evaluations', 'tool' => 'التقييم الدوري', 'path' => '/evaluations', 'checks' => 'ظاهر تحت الموارد البشرية · إنشاء 2026-Q3 · رفض التكرار · أرشفة · ظهور السجل في الملف الوظيفي · إظهار للموظف اختياري'],
                ['id' => 'responsibilities', 'tool' => 'المسؤوليات', 'path' => '/responsibilities', 'checks' => 'إضافة بند · إيقاف · ترتيب · فلتر النشطة'],
                ['id' => 'attendance', 'tool' => 'الحضور', 'path' => '/attendance', 'checks' => 'تفعيل · حضور/انصراف · إقرار بلا تغيير وقت · تأخر · طباعة شهرية · دورة حياة موضحة'],
                ...
                ['id' => 'hr-lifecycle', 'tool' => 'التهيئة وإنهاء العلاقة', 'path' => '/hr-lifecycle', 'checks' => 'موانع · مهام قابلة للمتابعة · تراجع · تجميد مؤقت · تعذّر إنهاء الذات'],
            ],
        ],
        [
            'id' => 'structure',
        ...
        [
            ...
            'items' => [
                ['id' => 'roles', 'tool' => 'الأدوار والصلاحيات (مُدمَج)', 'path' => '/settings/grants', 'checks' => 'تبويب الأدوار: إنشاء/إعادة تسمية/حذف · أسماء معرّبة'],
                ['id' => 'grants', 'tool' => 'صلاحيات واستثناءات (مُدمَج)', 'path' => '/settings/grants', 'checks' => 'تبويب صلاحيات الأدوار · استثناءات بسبب وتاريخ · من يملك ماذا'],
            ],
        ],
        [
            'id' => 'esnad',
