    ...
    'groups' => [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'contracts-hr', 'tool' => 'عقود العاملين', 'path' => '/contracts', 'checks' => 'عمود الراتب الشهري · حالات · رفع ملف · تنبيه انتهاء', 'lifecycle' => 'إنشاء عقد → رفع مرفق → تجديد/انتهاء'],
                ...
                ['id' => 'attendance-cycle', 'tool' => 'دورة الحضور', 'path' => '/attendance/cycle', 'checks' => 'دورة شهرية · استثناءات · اعتماد · ربط بالرواتب', 'lifecycle' => 'فتح دورة → مراجعة → اعتماد → إغلاق'],
