...
class PlatformSettingsSeeder extends Seeder
{
    ...
    private const SETTINGS = [
        ...
        ['attendance.cycle_start_day', '25', 'integer', 'يوم بداية دورة الحضور'],
        ['attendance.cycle_days', '30', 'integer', 'عدد أيام الدورة لقيمة اليوم'],
        ['attendance.grace_minutes', '15', 'integer', 'سماح التأخير بالدقائق'],
        ['attendance.absence_multiplier', '1.5', 'float', 'مضاعف خصم الغياب'],
        ['attendance.absence_policy', 'ثابت', 'string', 'سياسة الغياب: ثابت أو تصاعدي'],
        ['hr.daily_base_hours', '8', 'float', 'الساعات الأساسية اليومية'],
        ['attendance.site_barcode_token', 'hollal-site-demo', 'string', 'رمز باركود المقر'],
