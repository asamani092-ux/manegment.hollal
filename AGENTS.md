...
- **لا** لقطات شاشة ولا تسجيل فيديو ولا تجربة GUI من الوكيل، ولا إطالة المدة بها.
- الاستثناء الوحيد: تعذّر حل المشكلة إلا بهذه الطريقة — ويُطلب الإذن من المستخدم قبل التنفيذ.
